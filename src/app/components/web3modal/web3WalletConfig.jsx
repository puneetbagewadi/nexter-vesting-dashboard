...
import { mainnet, optimism, polygon,bsc, arbitrum,fantom,polygonZkEvm, celo, polygonMumbai, bscTestnet  } from "wagmi/chains";

if (!process.env.NEXT_PUBLIC_WALLET_MODAL_PROJECT_ID) {
  throw new Error("You need to provide NEXT_PUBLIC_WALLET_MODAL_PROJECT_ID env variable");
}
const projectId = process.env.NEXT_PUBLIC_WALLET_MODAL_PROJECT_ID;

// 2. Configure wagmi client
const chains = [mainnet, polygon,bsc,polygonMumbai, bscTestnet ];
    ...
    <>
      ...
      <Web3Modal
       ...
       themeVariables={{
          ...
          '--w3m-logo-image-url': 'https://github-production-user-asset-6210df.s3.amazonaws.com/79899121/256473779-80a51633-4b98-4696-b29b-104ecb459f3a.png'
        }}
      />
    </>
  )
